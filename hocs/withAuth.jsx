...
import { getFromLocalStorage, getImage, saveToLocalStorage } from "@/utils";
...
function withAuth(Component) {
    ...
    useEffect(() => {
        ...
        if (loader) return <div className="flex items-center justify-center">Loading...</div>;
        if (!loggedIn) {
            return (
                <div className="app mobView">
                    <Onboarding handleClick={handleClick} open={open} signInLoader={signInLoader} />
                </div>
            );
        }
