...
schema_view = get_schema_view(
   openapi.Info(
      title="Pulse Backend APIs",
      default_version='v1',
      description="List of APIs used in Pulse",
...
urlpatterns = [
    ...
    url('api/challenges', views.create_challenge),
    path('api/challenge/<challenge_id>/', views.get_challenge), 
